...
describe('DashboardPage', () => {
  ...
  it('renders counts without child-name props', async () => {
    vi.mocked(getAdminDashboard).mockResolvedValue({
      ...
      coverageBySection: [
        { sectionId: '66666666-6666-6666-6666-666666666666', sectionName: 'UKG A', childrenWithFreshOutcomes: 2 },
      ],
      sectionsBehindCount: 1,
      sectionsTotal: 1,
      communicationReplyWithinDayRate: 0.5,
      needsSupportBySection: [
        { sectionId: '66666666-6666-6666-6666-666666666666', sectionName: 'UKG A', stalledCount: 0 },
      ],
    });
    ...
    expect(screen.getByText(/UKG A — 2 children/)).toBeInTheDocument();
