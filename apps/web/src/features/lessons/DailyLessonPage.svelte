...
<main class="mx-auto max-w-3xl px-4 py-8">
  ...
  <div class="mt-4 flex gap-2">
    <button type="button" class="rounded-lg bg-emerald-700 px-3 py-2 text-sm text-white" onclick={handleGenerate}>
      Generate lesson
    </button>
    <button type="button" class="rounded-lg border px-3 py-2 text-sm" onclick={handleDone}>
      Mark taught
    </button>
  </div>
