...
const EXPECTED = {
  schools: { min: 1 },
  sections: { min: 2, note: 'Phase 3 — UKG + Grade 1' },
  bands: { min: 2, note: 'pre_primary + basic_early' },
  grade_scales: { min: 13, note: '3 pre_primary + 4 rating + 6 letter' },
  outcomes: { min: 17, note: '12 pre_primary + 5 Grades 1–3 placeholders' },
  subjects: { min: 5, note: 'Phase 3 — Grades 1–3 subjects' },
  band_subjects: { min: 5, note: 'Phase 3 — basic_early subject links' },
  identities: { min: 8, note: 'Phase 3 — +3 Grade 1 teachers' },
  school_memberships: { min: 7 },
  school_admins: { min: 1 },
  teachers: { min: 4, note: 'Phase 3 — UKG + math/english/class teacher' },
  guardians: { min: 2 },
  children: { min: 5, note: 'Phase 3 — +2 Grade 1 children' },
  guardian_child_links: { min: 3 },
  teacher_sections: { min: 4 },
